...
const GradientSvg: React.FC<GradientSvgProps> = ({ className, isHovered, colors }) => {
  ...
  const variants = {
    hovered:    { gradientTransform, transition: { duration: 120, repeat: Infinity, ease: 'linear' as const } },
    notHovered: { gradientTransform, transition: { duration: 40, repeat: Infinity, ease: 'linear' as const } },
  };

  return (
    <svg className={className} width="1030" height="280" viewBox="0 0 1030 280" fill="none">
